...
- **ASIACCS 2025**
  - [AWOSE: Probabilistic State Model for Consensus Algorithms’ Fuzzing Frameworks](https://dl.acm.org/doi/10.1145/3708821.3733876)
  - [REFLECTA: Reflection-based Scalable and Semantic Scripting Language Fuzzing](https://dl.acm.org/doi/10.1145/3708821.3710818)
  - [RVISmith: Fuzzing Compilers for RVV Intrinsics](https://arxiv.org/abs/2507.03773)
- **SP 2025**
...
- [IoT or protocols fuzzing](#iot-or-protocols-fuzzing)
    - [Fuzzing Matter(s): A White Paper for Fuzzing the Matter Protocol](#fuzzing-matters-a-white-paper-for-fuzzing-the-matter-protocol)
    - [Crash Report Accumulation During Continuous Fuzzing with CASR (IVMEM 2024)](#crash-report-accumulation-during-continuous-fuzzing-with-casr-ivmem-2024)
    - [No More Companion Apps Hacking but One Dongle: Hub-Based Blackbox Fuzzing of IoT Firmware (MobiSys 2023)](#no-more-companion-apps-hacking-but-one-dongle-hub-based-blackbox-fuzzing-of-iot-firmware-mobisys-2023)
