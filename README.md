...
- [IoT or protocols fuzzing](#iot-or-protocols-fuzzing)
    ...
    - [Fw‐fuzz: A code coverage‐guided fuzzing framework for network protocols on firmware (2020)](#fwfuzz-a-code-coverageguided-fuzzing-framework-for-network-protocols-on-firmware-2020)
